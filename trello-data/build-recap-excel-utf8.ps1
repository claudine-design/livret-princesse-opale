...
$cols = @(
  ...
  'Bouilloire','Grille-pain','Vaisselle complète','Savon + shampoing hypoallergénique',
...
for ($i = 0; $i -lt $apparts.Count; $i++) {
  ...
  $vals = @(
    ...
    'Oui', 'Oui', 'Oui (assiettes, verres, casserole, poêle, plat à tarte)', 'Oui (hypoallergénique, OK enfants)',
